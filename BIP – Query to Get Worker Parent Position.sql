SELECT  papf_emp.person_number employee_number,
                ppnf.first_name||' '||ppnf.last_name employee_name,
                                      hapft.name employee_position,
                                      hapft.name employee_position_parent
...
LEFT JOIN hr_all_positions_f_tl hapft ON hapft.position_id = hapf.position_id AND USERENV('LANG') = hapft.LANGUAGE 
